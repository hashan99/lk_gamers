main()
{
	...
	setDvar( "scr_sd_roundlimit", 0 ); // [0->] (points)
	...
	setDvar( "scr_dom_timelimit", 10 ); // [0->] (minutes)
	...
	setDvar( "scr_koth_timelimit", 10 ); // [0->] (minutes)
	...
	setDvar( "class_specops_limit", 20 );
	setDvar( "class_demolitions_limit", 20 );
	setDvar( "class_sniper_limit", 20 );
	...
	setDvar( "class_demolitions_camo"
, "camo_none" );
	...
	setDvar( "promod_allow_strattime", 6 ); // [0-1] (sd only)
	...
	setDvar( "promod_mc_message_1", "^2Donate Rs 200 For Server Maintenance" );
	setDvar( "promod_mc_message_2", "^1Powered by LK_Gamers" );
	setDvar( "promod_mc_message_3", "^1visit us www.lkgamers.tk" ); //<*nextmap*>
	setDvar( "promod_mc_messagedelay_1", 2 ); // [1->] (overrides default delay in seconds between messages, e.g special messages)
	setDvar( "promod_mc_messagedelay_2", 2 );
	setDvar( "promod_mc_messagedelay_3", 2 );
}
